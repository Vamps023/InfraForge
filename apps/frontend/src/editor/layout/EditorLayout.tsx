...
// plus a central viewport/workspace. Panel visibility and resizing are driven
// by the layout store (persisted USER preferences, separate from project
// state — ADR-0009). The native viewport host is rendered in the center and
// continues to behave correctly with panel resize/hide/show (the host's
// ResizeObserver re-reports bounds on every layout change).
  ...
  return (
    <div className="editor-layout">
      <div className="editor-layout-row">
        ...
        <div className="editor-center">{viewport}</div>
