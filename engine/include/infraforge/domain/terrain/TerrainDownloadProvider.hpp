...
public:
    ...
    // download plan covering the selected tiles (Item 7). This is
    // provider-specific: Terrarium computes it from its fixed zoom level
    // and Web Mercator latitude-dependent ground resolution across the
    // selected tiles. Returns 0.0 if the selection is empty.
